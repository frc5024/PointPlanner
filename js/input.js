// modified from https://github.com/rsninja722/game.js
...
var preventedEvents = [false,true,false];
...
function addListenersTo(elementToListenTo) {
    ...
    elementToListenTo.addEventListener("touchstart", touchDown);
    elementToListenTo.addEventListener("touchmove", touchMove);
    elementToListenTo.addEventListener("touchend", touchUp);
    elementToListenTo.addEventListener("touchcancel", touchUp);
}
function resetInput() {
